...
<option value="">Select Class</option>
                         ...
                         <div class="form-group mt-20">
                           ...
                           <a href="result.php"><button type="submit" class="btn btn-success btn-labeled pull-right">Search<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button></a>
